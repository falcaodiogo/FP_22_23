...
def loadDataBase(fname, produtos):
    ...
    with open(fname, "r") as db:
        ...
        for entry in db:
            ...
            produtos[code] = (comps[1],comps[2],float(comps[3]),float(comps[4].rstrip("%")), 100)
...
def registaCompra(produtos):
    ...
    while True:
        ...
        if code in produtos:
            ...
            print(produto[NOME], amount, precoTotal)
